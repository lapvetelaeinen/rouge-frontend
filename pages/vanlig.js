...
import BandImage from "../assets/img/ticket.jpg";
...
export default function EventPage() {
  ...
  const [ticketClass, setTicketClass] = useState("Vanlig");
              ...
              <div className="flex flex-col">
                ...
                <div className="mx-5 flex items-center mb-8">
                  ...
                  <div className="pl-5 text-neutral-700">
                    <p className="text-2xl">Vanlig entré</p>
